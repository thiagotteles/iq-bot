	...
	if datetime.now().second == 0 and horaVerificacao.minute != datetime.now().minute:
		...
		with open('sinais.txt') as json_file:
			...
			for op in dados:
				...
				if valorSoros > 0:
					if qtdEntradas == 1:
						valor_entrada_b = valor_entrada_b + valorSoros
					elif qtdEntradas == 2:
						valor_entrada_b = valor_entrada_b + (0.32 * valorSoros)
						gale1 = gale1 + (0.68 * valorSoros)
					elif qtdEntradas == 3:
						valor_entrada_b = valor_entrada_b + (0.13 * valorSoros)
						gale1 = gale1 + (0.28 * valorSoros)
						gale2 = gale2 + (0.59 * valorSoros)
